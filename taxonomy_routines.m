...
projects(15).Name='Autopatcher';
projects(15).listPath=[locations.tgtardir,'ANALYSISdata/marci/_Taxonomy/Autopatcher'];
projects(15).listName='autopatch.txt';
projects(15).xlsname='autopatch.xls';
